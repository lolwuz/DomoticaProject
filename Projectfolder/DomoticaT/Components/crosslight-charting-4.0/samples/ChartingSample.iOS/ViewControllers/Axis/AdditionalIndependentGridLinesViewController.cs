...
namespace ChartingSample.iOS
{
    ...
    public partial class AlternatingIndependentGridLinesViewController : UIViewController<AlternatingIndependentGridLinesViewModel>
    {
        ...
        protected override void InitializeView ()
        {
            ...
            this.NavigationItem.Title = "Alternating Independent GridLines";
