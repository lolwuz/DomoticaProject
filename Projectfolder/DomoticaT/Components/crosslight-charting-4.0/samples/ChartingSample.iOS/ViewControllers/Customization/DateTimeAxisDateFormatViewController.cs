...
namespace ChartingSample.iOS
{
    ...
    public partial class DateTimeAxisDateFormatViewController : UIViewController<DateTimeAxisDateFormatViewModel>
    {
        ...
        protected override void InitializeView ()
        {
            ...
            UIBarButtonItem changeDateFormatButton = new UIBarButtonItem(UIBarButtonSystemItem.Action);
            ...
            UIBarButtonItem[] barButton = new UIBarButtonItem[5];
            barButton [4] = changeDateFormatButton;
            ...
            this.RegisterViewIdentifier ("ChangeDateFormatButton", changeDateFormatButton);
